        ...
        {products.map((product, index) => (
          <div key={index} className="product-card">
            ...
            <div className="product-info">
              <h3>{product.productName} <button onClick={() => handleAddToCart(product)}><i className="fa fa-shopping-bag"></i></button>
              <button onClick={() => handleAddToFavorites(product)}><i className="fa fa-heart"></i></button></h3>
